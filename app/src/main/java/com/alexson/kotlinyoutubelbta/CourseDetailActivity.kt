package com.alexson.kotlinyoutubelbta
...
//                println(body)
   ...
   class CourseLessonViewHolder(val customView: View, var courseLesson: CourseLesson? =
    null): RecyclerView.ViewHolder(customView){
